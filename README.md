...
```js
let userName = "aj"; // data type inferred as string
```
...
- Array Type- similar data
  ...
  ```js
  // let users = ["ayon", "rabu", "pinky"];

  // let users: string[];
  // users = ["ayon", "rabu", "pinky"];
...
- object Type: can store value as key value pair
  ...
  user1 = { userName: "ayon", userId: 101 };
  users.push(user1);
...
- Example
  ...
  let user1 = new User("Ayon Jodder", 25);
  user1.display();
...
const s1 = new Student("ayon jodder", "1302020017");
...
- example
  ...
  userInfo1 = () => {
    console.log("Ayon Jodder is 24 years old");
  };
  ...
  userInfo3 = (name: string): string => {
    return `${name} is 24 years old`;
  };

  userInfo1();
  userInfo2("Ayon Jodder");
  console.log(userInfo3("Ayon Jodder"));
  ```
